...
|---|---|---|---|---|---|
| 2 | `OBJ-PROVE-TIMERS` | Prove default timer selection by decision boundary | Every advertised route is proved universally and every host-dependent choice is measured once | Honest charts and performance claims | [objective](objectives/prove-timers.md) |
...
No objective has owner-accepted closure evidence yet.
