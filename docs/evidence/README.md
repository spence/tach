...
Tracked packages are the proof of record for gates and measured claims. Raw work may happen in
scratch output, but durable documents link only to a package here. Supersede a package with a later
dated package; do not silently rewrite a verdict.
...
| `EVID-PRIMARY-SPEED-CAMPAIGN` | 🟢 | [`timers/primary-speed-campaign-2026-07-18/README.md`](timers/primary-speed-campaign-2026-07-18/README.md) |
...
| `EVID-WINDOWS-FLIP` |  | [`timers/windows-flip-2026-07-16/README.md`](timers/windows-flip-2026-07-16/README.md) |
<!-- /render:evid-index -->
